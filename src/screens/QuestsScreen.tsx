...
export const QuestsScreen: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full py-5 px-5 relative safe-area-inset overflow-hidden" style={{ background: 'linear-gradient(160deg, #0F172A 0%, #0d1f5c 50%, #1E3A8A 100%)', isolation: 'isolate' }}>
      {/* Ambient orbs */}
